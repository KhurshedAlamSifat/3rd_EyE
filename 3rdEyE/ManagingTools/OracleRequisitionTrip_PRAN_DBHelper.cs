...
{
    public class OracleRequisitionTrip_PRAN_DBHelper
    {
        public static string ConStr;

        public OracleRequisitionTrip_PRAN_DBHelper()
        {
            ConStr = System.Configuration.ConfigurationManager.ConnectionStrings["OracleRequisitionTrip_PRAN"].ConnectionString;
        }
        ...
        public static bool DbSaveChanges(List<string> SqlCommandList)
        {
            ...
            {
                new OracleRequisitionTrip_PRAN_DBHelper();
            }
            bool result = true;
