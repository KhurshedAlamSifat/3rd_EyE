...
{
    public class _OracleRequisitionTrip_RFL_DBHelper
    {
        public static string ConStr;

        public _OracleRequisitionTrip_RFL_DBHelper()
        {
            ConStr = System.Configuration.ConfigurationManager.ConnectionStrings["_OracleRequisitionTrip_RFL"].ConnectionString;
        }
        ...
        public static bool DbSaveChanges(List<string> SqlCommandList)
        {
            ...
            {
                new _OracleRequisitionTrip_RFL_DBHelper();
            }
            bool result = true;
