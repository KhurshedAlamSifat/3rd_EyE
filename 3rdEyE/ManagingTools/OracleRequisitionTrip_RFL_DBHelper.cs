...
{
    public class OracleRequisitionTrip_RFL_DBHelper
    {
        public static string ConStr;

        public OracleRequisitionTrip_RFL_DBHelper()
        {
            ConStr = System.Configuration.ConfigurationManager.ConnectionStrings["OracleRequisitionTrip_RFL"].ConnectionString;
        }
        ...
        public static bool DbSaveChanges(List<string> SqlCommandList)
        {
            ...
            {
                new OracleRequisitionTrip_RFL_DBHelper();
            }
            bool result = true;
