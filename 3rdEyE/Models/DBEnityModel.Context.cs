...
namespace _3rdEyE.Models
{
    ...
    public partial class DBEnityModelContainer : DbContext
    {
        public DBEnityModelContainer()
            : base("name=DBEnityModelContainer")
        {
        }
        ...
        public virtual DbSet<AppUser_AppMenu> AppUser_AppMenu { get; set; }
        public virtual DbSet<AppUser_AppPermission> AppUser_AppPermission { get; set; }
        public virtual DbSet<AppUser_AppSubMenu> AppUser_AppSubMenu { get; set; }
        ...
        public virtual DbSet<DHT_RequisitionTrip> DHT_RequisitionTrip { get; set; }
        ...
        public virtual DbSet<FuelConsumptionDemand> FuelConsumptionDemands { get; set; }
        ...
        public virtual DbSet<LoadingBay> LoadingBays { get; set; }
        public virtual DbSet<LoadingBayUtilization> LoadingBayUtilizations { get; set; }
        public virtual DbSet<Location> Locations { get; set; }
        public virtual DbSet<LocationBuilding> LocationBuildings { get; set; }
        ...
        public virtual DbSet<ParkingInOut> ParkingInOuts { get; set; }
        ...
        public virtual DbSet<PranOrganization> PranOrganizations { get; set; }
        ...
        public virtual DbSet<Report_VehicleRunAndHaltReport> Report_VehicleRunAndHaltReport { get; set; }
        public virtual DbSet<Report_VehicleRunAndHaltReport_Helper> Report_VehicleRunAndHaltReport_Helper { get; set; }
        ...
        public virtual DbSet<RFLOrganization> RFLOrganizations { get; set; }
        ...
        public virtual DbSet<TransportAgency> TransportAgencies { get; set; }
        ...
        public virtual DbSet<VehicleOutInManual> VehicleOutInManuals { get; set; }
        public virtual DbSet<VehicleOutStayNonMoving> VehicleOutStayNonMovings { get; set; }
        ...
        public virtual DbSet<VehicleTrackingVT1> VehicleTrackingVT1 { get; set; }
        public virtual DbSet<VehicleTrip> VehicleTrips { get; set; }
        public virtual DbSet<VehicleWeightTransection> VehicleWeightTransections { get; set; }
        public virtual DbSet<VTS_InactiveLog> VTS_InactiveLog { get; set; }
        public virtual DbSet<VTS_T366_DataModel> VTS_T366_DataModel { get; set; }
        ...
        public virtual DbSet<vw_ParkingInOut> vw_ParkingInOut { get; set; }
        public virtual DbSet<vw_ParkingInOut_2> vw_ParkingInOut_2 { get; set; }
        public virtual DbSet<vw_ParkingInOut_Detail> vw_ParkingInOut_Detail { get; set; }
        public virtual DbSet<vw_ParkingInOut_Detail_2> vw_ParkingInOut_Detail_2 { get; set; }
        public virtual DbSet<vw_ParkingInOut_Live> vw_ParkingInOut_Live { get; set; }
        public virtual DbSet<vw_Requisition> vw_Requisition { get; set; }
        public virtual DbSet<vw_RequisitionTrip> vw_RequisitionTrip { get; set; }
        public virtual DbSet<vw_RequisitionTripCustomReport> vw_RequisitionTripCustomReport { get; set; }
        public virtual DbSet<vw_VehicleInOutManual> vw_VehicleInOutManual { get; set; }
        public virtual DbSet<vw_VehicleTracking> vw_VehicleTracking { get; set; }
        ...
        public virtual int Move_RequisitionTrip()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Move_RequisitionTrip");
        }
        ...
        public virtual ObjectResult<string> PushDeviceData_Update_Insert(Nullable<System.Guid> pK_Vehicle, string gpsIMEINumber, Nullable<System.DateTime> updateTime, string latitude, string longitude, Nullable<decimal> mileage, string altitude, string engineStatus, string course, string temperature, string fuel, string speed, string distance, string eventCode, string status_PostionValidity, Nullable<int> status_SateliteCount, Nullable<int> status_GSMSignalStrength, Nullable<int> remainingCash, Nullable<bool> isLocationChanged)
        {
            ...
            var isLocationChangedParameter = isLocationChanged.HasValue ?
                new ObjectParameter("IsLocationChanged", isLocationChanged) :
                new ObjectParameter("IsLocationChanged", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PushDeviceData_Update_Insert", pK_VehicleParameter, gpsIMEINumberParameter, updateTimeParameter, latitudeParameter, longitudeParameter, mileageParameter, altitudeParameter, engineStatusParameter, courseParameter, temperatureParameter, fuelParameter, speedParameter, distanceParameter, eventCodeParameter, status_PostionValidityParameter, status_SateliteCountParameter, status_GSMSignalStrengthParameter, remainingCashParameter, isLocationChangedParameter);
        }
    
        public virtual ObjectResult<string> PushDeviceData_Update_Insert_VT1(Nullable<System.Guid> pK_Vehicle, string gpsIMEINumber, Nullable<System.DateTime> updateTime, string latitude, string longitude, string altitude, string engineStatus, string course, string temperature, string fuel, string speed, string distance, string eventCode, string status_PostionValidity, Nullable<int> status_SateliteCount, Nullable<int> status_GSMSignalStrength, Nullable<int> remainingCash, Nullable<bool> isLocationChanged)
        {
            var pK_VehicleParameter = pK_Vehicle.HasValue ?
                new ObjectParameter("PK_Vehicle", pK_Vehicle) :
                new ObjectParameter("PK_Vehicle", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("PushDeviceData_Update_Insert_VT1", pK_VehicleParameter, gpsIMEINumberParameter, updateTimeParameter, latitudeParameter, longitudeParameter, altitudeParameter, engineStatusParameter, courseParameter, temperatureParameter, fuelParameter, speedParameter, distanceParameter, eventCodeParameter, status_PostionValidityParameter, status_SateliteCountParameter, status_GSMSignalStrengthParameter, remainingCashParameter, isLocationChangedParameter);
        }
        ...
        public virtual ObjectResult<Report_GetVehicleRunAndHaltReport_Result> Report_GetVehicleRunAndHaltReport(string uSER_KEY, Nullable<System.Guid> fK_Vehicle, Nullable<System.DateTime> startingDate, Nullable<System.DateTime> endingDate)
        {
            var uSER_KEYParameter = uSER_KEY != null ?
                new ObjectParameter("USER_KEY", uSER_KEY) :
                new ObjectParameter("USER_KEY", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Report_GetVehicleRunAndHaltReport_Result>("Report_GetVehicleRunAndHaltReport", uSER_KEYParameter, fK_VehicleParameter, startingDateParameter, endingDateParameter);
        }
        ...
        public virtual int SP_JOB_InsertDeviceData()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_JOB_InsertDeviceData");
        }
        ...
        public virtual int VTS_SIM_VerificationReceive(string simNumber, Nullable<System.DateTime> receivedAt, string receivedMessage, string resIMEI)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("VTS_SIM_VerificationReceive", simNumberParameter, receivedAtParameter, receivedMessageParameter, resIMEIParameter);
        }
    
        public virtual int VTS_SIM_VerificationSend(string simNumber, string appVehicleRegistration, string appVehicleIMEI, Nullable<System.DateTime> sentAt, string sentMessage)
        {
            var simNumberParameter = simNumber != null ?
                new ObjectParameter("SimNumber", simNumber) :
                new ObjectParameter("SimNumber", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("VTS_SIM_VerificationSend", simNumberParameter, appVehicleRegistrationParameter, appVehicleIMEIParameter, sentAtParameter, sentMessageParameter);
        }
    
        public virtual ObjectResult<MYSP_CreateModel_Result> MYSP_CreateModel(string objname)
        {
            var objnameParameter = objname != null ?
                new ObjectParameter("objname", objname) :
                new ObjectParameter("objname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MYSP_CreateModel_Result>("MYSP_CreateModel", objnameParameter);
        }
    
        public virtual ObjectResult<MYSP_Help_Result> MYSP_Help(string objname)
        {
            var objnameParameter = objname != null ?
                new ObjectParameter("objname", objname) :
                new ObjectParameter("objname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MYSP_Help_Result>("MYSP_Help", objnameParameter);
        }
    
        public virtual ObjectResult<f_MYSP_Help_Result> f_MYSP_Help(string objname)
        {
            var objnameParameter = objname != null ?
                new ObjectParameter("objname", objname) :
                new ObjectParameter("objname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<f_MYSP_Help_Result>("f_MYSP_Help", objnameParameter);
        }
    }
}
